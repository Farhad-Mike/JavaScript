...
byts.byteLength; 			// Сумма всей байтов
byts.set(fromArr, [offset])	// копирует все элементы из fromArr в arr, добавляет в byts начиная с позиции offset (0 по умолчанию)
