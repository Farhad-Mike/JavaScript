...
localStorage.set('key', 'value'); 	// Использовать локальный storage. Всегда используется формат строк.
localStorage.get('key');
localStorage.remove('key'); 		// Удалить key=value
localStorage.clear();				// Очистить весь локальный storage.
sessionStorage.set('key', 'value'); // Использовать storage на одну сессию. Всегда используется формат строк.
sessionStorage.get('key');
sessionStorage.remove('key'); 		// Удалить key=value
